...
Examples:
    ...
    - python scripts/compare_swanlab_configs.py https://swanlab.ai/ai2-llm/olmo-medium/runs/cej4ya39 https://swanlab.ai/ai2-llm/olmoe/runs/rzsn9tlc

    Comparing Peteish7 to Amberish7
    - python scripts/compare_swanlab_configs.py https://swanlab.ai/ai2-llm/olmo-medium/runs/cej4ya39 https://swanlab.ai/ai2-llm/olmo-medium/runs/ij4ls6v2
...
run_path_url = re.compile(r"^https?://swanlab.ai/([^/]+)/([^/]+)/runs/([^/]+)")
