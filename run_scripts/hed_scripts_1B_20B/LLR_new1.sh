...
torchrun --nproc_per_node=8 --master_port=35700 --master_addr=localhost scripts/train_llama.py \
  ...
  --LLR.lr_max_ratio=4 \
  --LLR.linear_steps=50 \
  --swanlab.name=t5-1024-LLR0-1B-lr0_0005-1-4 \
  --save_folder=workspace/t5-1024-LLR0-1B-lr0_0005-1-4 \
#   --load_path=